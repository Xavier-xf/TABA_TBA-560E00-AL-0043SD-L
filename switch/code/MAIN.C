...
{
	POWER_LED = !POWER_LED;
	set_timer(TIMER0,TID_1SEC,led_blink);
}
...
void InitUart1(void)
{
	...
	UART1_SetBaudRateX1();									//使能双倍波特率
	UART1_SetRxTxP12P13();									//设置串口使用引脚：RX:P12 TX:P13
	UART1_EnReception();									//使能串口接收功能
	UART1_SetS1BRGSelSYSCLK();								//设置S1BRG时钟源为系统时钟：1T

	UART1_SetS1BRGValue(S1BRG_BRGRL_9600_1X_12000000_1T);	//设置S1BRG值及重载值
