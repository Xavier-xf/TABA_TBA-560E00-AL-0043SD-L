...
static struct resolution_t  s_res_group[VO_RES_GROUP]=
{
    {1920,1080},            /*   1080P */
    {2304,1296},
    {2560,1440},
...
static char ac_option_hint[  ][ LEN_HINT ] = {                                         //操作提示数组
    ...
    "文件分辨率索引 0,1920*1080 1,2304,1296 2,2560*1440 3,2560*1920 4,320*240" ,
    "yuv文件路径" ,
    "分屏数目1-4" ,
...
static struct option option_long[ ] = {
    ...
    { "file-resulotion"   , required_argument , NULL , 'r' } ,      //"文件分辨率索引 0,1920*1080 1,2304,1296 2,2560*1440 3,2560*1920" ,
...
{
    printf("\nexample: \r\n"
            "\t%s -w 1024 -e 600 -x 0 -r 0 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n"
            "\t%s -w 1280 -e 800 -x 90 -r 0 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n"
            "\t%s -w 1920 -e 1200 -x 90 -r 0 -f /mnt/yuv -n 1 -i 4 -o 1 -l /mnt/anyka.logo.577.160.rgb\n" ,
            name, name, name );
...
__STATIC__ int main(int argc, char **argv)
{
    ...
    if ((dst_width >= LOGO_WIDTH) && (dst_height >= LOGO_HEIGHT))
    {
    ...
    int src_width = s_res_group[resolution_index].width;
    int src_height = s_res_group[resolution_index].height;

    int len = (src_width*src_height*3)/2;
    ...
    case GP_FORMAT_BGR565:
        len = src_width*src_height*2;
        break;
    /* 888 */
    case GP_FORMAT_BGR888:
    case GP_FORMAT_RGB888:
        len = src_width*src_height*3;
        break;
    /* 8888 */
    ...
    while ((entry = readdir(dir)))
    {
        if (entry->d_type == DT_REG)
        {
            ...
            if(fp!= NULL)
            {
                ...
                obj.vo_layer.width = src_width;
                obj.vo_layer.height = src_height;
                obj.vo_layer.clip_pos.top = 0;
                obj.vo_layer.clip_pos.left = 0;
                obj.vo_layer.clip_pos.width = src_width;
                obj.vo_layer.clip_pos.height = src_height;
