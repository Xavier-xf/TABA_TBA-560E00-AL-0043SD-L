...
static struct spinand_flash_info ak_spinand_param_supportlist [] = {
    ...
    { "XT26G01C", 0x1100110b, 0, 1, 2048, 64, 2048*64, 1024, 64, 0, 16, 0, 4, 4, SFLAG_DUAL_READ|SFLAG_QUAD_READ|SFLAG_QUAD_WRITE,},
		...
		unsigned int max_hz, unsigned int spi_mode)
{
    ...
    if (flash->flashid == 0x242c242c) { // XT26G02E, after powerup the device is in the locked state by default                                                                             
